...
public class AspectJExpressionPointcutDemo {
    ...
    public static void main(String[] args) {
        ...
        String pointcutExpression = "@annotation(org.chance.spring.feature.aop.AspectJExpressionPointcutDemo.AfterTransaction)"; // 拦截上方法标有@AfterTransaction此注解的任意方法们
