...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static Date concat(String ymd, String hm) {
        if (!org.apache.commons.lang3.StringUtils.isBlank(ymd) && !StringUtils.isBlank(hm)) {
            try {
     ...
     * 返回该天从00:00:00开始的日期
     */
    public static long getStartDatetime(long ts) {
        return getStartDatetime(ts, 0);
    }
     ...
     * 返回该天从00:00:00开始的日期
     */
    public static long getStartDatetime(long ts, Integer diffDays) {
        SimpleDateFormat dateFormat = new SimpleDateFormat(DATE_FORMAT);
        String thisDate = dateFormat.format(ts + MILLIS_PER_DAY * diffDays);
        Date retDate = convert(thisDate + " " + DAYTIME_START, DateUtils.DATE_TIME_FORMAT);
     ...
     * 返回n天到23:59:59结束的日期
     */
    public static long getEndDatetime(long ts, Integer diffDays) {
        SimpleDateFormat dateFormat = new SimpleDateFormat(DATE_FORMAT);
        String thisDate = dateFormat.format(ts + MILLIS_PER_DAY * diffDays);
        Date retDate = convert(thisDate + " " + DAYTIME_END);
        return retDate.getTime();
    }
...
//        calendar.setTime(date);
        ...
        System.out.println(getStartDatetime(System.currentTimeMillis(), 1));
        System.out.println(new Date(getStartDatetime(System.currentTimeMillis(), 1)));
        System.out.println(getStartDatetime(System.currentTimeMillis()));
        System.out.println(new Date(getStartDatetime(System.currentTimeMillis())));

        System.out.println(getEndDatetime(System.currentTimeMillis(), 2));
        System.out.println(new Date(getEndDatetime(System.currentTimeMillis(), 2)));

        System.out.println(getEndDatetime(System.currentTimeMillis(), 3));
        System.out.println(new Date(getEndDatetime(System.currentTimeMillis(), 3)));
